      ...
      <div className="flex flex-wrap flex-row">
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            ...
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img1.jpg" alt="Image Description"/> */}
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            <a
              ...
              className="glightbox3"
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img2.jpg" alt="Image Description"/> */}
              <div className="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 className="text-base leading-normal font-semibold my-1 text-white">
                  Web Development
                </h3>
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            <a
              ...
              className="glightbox3"
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img3.jpg" alt="Image Description"/> */}
              <div className="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 className="text-base leading-normal font-semibold my-1 text-white">
                  Graphic Design
                </h3>
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            <a
              ...
              className="glightbox3"
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img4.jpg" alt="Image Description"/> */}
              <div className="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 className="text-base leading-normal font-semibold my-1 text-white">
                  Logo Design
                </h3>
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            <a
              ...
              className="glightbox3"
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img5.jpg" alt="Image Description"/> */}
              <div className="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 className="text-base leading-normal font-semibold my-1 text-white">
                  Web Development
                </h3>
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            <a
              ...
              className="glightbox3"
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img6.jpg" alt="Image Description"/> */}
              <div className="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 className="text-base leading-normal font-semibold my-1 text-white">
                  Graphic Design
                </h3>
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            <a
              ...
              className="glightbox3"
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img7.jpg" alt="Image Description"/> */}
              <div className="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 className="text-base leading-normal font-semibold my-1 text-white">
                  Logo Design
                </h3>
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            <a
              ...
              className="glightbox3"
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img8.jpg" alt="Image Description"/> */}
              <div className="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 className="text-base leading-normal font-semibold my-1 text-white">
                  Web Development
                </h3>
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            <a
              ...
              className="glightbox3"
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img9.jpg" alt="Image Description"/> */}
              <div className="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 className="text-base leading-normal font-semibold my-1 text-white">
                  Graphic Design
                </h3>
        ...
        >
          <div className="relative overflow-hidden cursor-pointer mb-6">
            <a
              ...
              className="glightbox3"
            >
              {/* <img className="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="src/img/dummy/img10.jpg" alt="Image Description"/> */}
              <div className="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 className="text-base leading-normal font-semibold my-1 text-white">
                  App Design
                </h3>
