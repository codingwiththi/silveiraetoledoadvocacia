...
import img1 from "../../public/dummy/avatar1.png";
import img2 from "../../public/dummy/avatar2.png";
import img3 from "../../public/dummy/avatar3.png";
import img4 from "../../public/dummy/avatar4.png";
      ...
      <div class="container xl:max-w-6xl mx-auto px-4">
        ...
        <header class="text-center mx-auto mb-12">
          <h2 class="text-2xl leading-normal mb-2 font-bold text-gray-800 dark:text-gray-100">
            <span class="font-light">Nosso</span> Time
          </h2>
          <svg
            version="1.1"
          ...
          <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
            ...
            >
              ...
              <div class="relative overflow-hidden px-6">
                ...
                <Image
                  className="grayscale mx-auto opacity-80 hover:opacity-100 rounded-full"
                  src={img1}
              ...
              <div class="pt-6 text-center">
                ...
                <p class="text-gray-500 leading-relaxed font-light">Advogado</p>
                {/* <!-- social icon --> */}
          ...
          <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
            ...
            >
              ...
              <div class="pt-6 text-center">
                ...
                <p class="text-gray-500 leading-relaxed font-light">Advogada</p>
                {/* <!-- social icon --> */}
                <div class="mt-2 mb-5 space-x-2">
                  <a
                    class="hover:text-blue-700"
